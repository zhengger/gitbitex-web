...
apiProxy = "http://192.168.0.39:8003";
  ...
  if (task.type == "concat") {
    ...
    (function (task, taskName) {
      return gulp.task(taskName, function (callback) {
        webpack(
          require("./gulp/webpack.config.js")(task, isProduction),
          function () {
            browserSync.reload();
            callback();
          }
    ...
    (function (task, taskName) {
      ...
      gulp.task(taskRev, function () {
        var pipe = gulp
          ...
          .pipe(plugins.rename(manifestName))
          .pipe(gulp.dest(task.build));
...
gulp.task("default", ["clean"], function () {
  if (isProduction) {
    return runSequence(
      tasks,
      "vendor.script.md5.rev",
      "vendor.script.md5.replace",
      "vendor.script.md5.clean",
      "app.script.md5.rev",
      "app.script.md5.replace",
      "app.script.md5.clean",
      "app.style.md5.rev",
      "app.style.md5.replace",
      "app.style.md5.clean",
      "app.md5.clean"
    );
